...
public class ColumnDividerActivity extends AppCompatActivity {

	public static void startUp(Context context) {
		context.startActivity(new Intent(context, ColumnDividerActivity.class));
	}

	private Context               mContext;
	private ColumnDraggableLayout mListView;

	@Override
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_column_divider);
		mContext = this;
		initView();
		initEvent();
		initData();
	...
	private void initView() {
		mListView = (ColumnDraggableLayout) findViewById(R.id.draggable_list_column_divider);
		mListView.setTitleBackground(mContext.getResources().getColor(R.color.colorAccent));
	}

	private void initEvent() {
		mListView.setAdapter(new ColumnDividerAdapter(this, obtainDraggableData()));
